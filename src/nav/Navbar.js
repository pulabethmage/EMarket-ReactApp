...
import profile from "../images/02.jpg";
      ...
      <div className="max-w-6xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2">
          ...
          <div
            className={`absolute  ${
              openProfile ? "" : "hidden"
            } duration-500 my-4 text-base list-none sm:right-4 2xl:right-48 bg-white divide-y divide-gray-100 rounded-lg top-16 shadow right-4 dark:bg-gray-700 dark:divide-gray-600`}
          >
        ...
        <div
          className={`items-center justify-between ${
            open ? "" : "hidden"
          } w-full md:flex md:w-auto md:order-1 duration-300`}
        >
